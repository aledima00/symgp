...
class OpRules:
    ...
    def __init__(self, arity:int, output_frule:Callable[[List[TypeSpec]], TypeSpec], input_types:List[TypeSpec]=None, output_types:TypeSpec=None, input_fcheck:Callable[[List[TypeSpec]], bool]=None):
        self.arity = arity
